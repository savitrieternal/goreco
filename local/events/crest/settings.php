...
// or
define('C_REST_WEB_HOOK_URL','https://crm.goreco.ru/rest/468/sa7i3ks4bww5xqew/');//url on creat Webhook
...
// define('C_REST_LOGS_DIR', __DIR__ .''); //directory path to save the log
// pass:
// eJdNGUK6F5
